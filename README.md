...
| Phase 8B+ — Real engine adapters, measurement gaps | **Planned** |
...
**Near-term focus:** Phase 8B real engine adapter integration (after governance remains intact), then measurement gap layer.
...
1. Phase 8B — real engine adapters (pinned fixtures first, governance intact)
