...
| GeoX method-promotion governance → MIP | `MethodPromotionGenericAdapterMIPHandoff` via consumer contract [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_CONTRACT_001.md), runtime contract [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_CONTRACT_001.md), runtime [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_001.md), and application checkpoint [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_APPLICATION_CHECKPOINT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_APPLICATION_CHECKPOINT_001.md) — **governance context only**; ready for routing/answerability contract planning, not integration; not DecisionSurface, TrustReport bypass, RecommendationContract, planning answer eligibility, or spend/ROI authorization |
