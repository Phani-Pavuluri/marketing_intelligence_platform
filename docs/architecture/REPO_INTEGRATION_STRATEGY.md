...
**Service wrapper (P10–P12):** FastAPI/Docker service through **P10c**; **P11** API contract hardening merged; **P12** deterministic SDK/API usage examples merged. **Stage A** fixtures, **Stage A.2** loaders, **Stage A.3** calibration adapter, and **calibration report export helpers** provide canonical deterministic demo inputs without MMM/GeoX execution outputs.
...
| GeoX method-promotion governance → MIP | `MethodPromotionGenericAdapterMIPHandoff` via consumer contract [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_CONTRACT_001.md), runtime contract [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_CONTRACT_001.md), runtime [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_001.md), application checkpoint [`MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_APPLICATION_CHECKPOINT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_CONSUMER_RUNTIME_APPLICATION_CHECKPOINT_001.md), routing/answerability contract [`MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_CONTRACT_001.md), routing/answerability runtime contract [`MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_CONTRACT_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_CONTRACT_001.md), routing/answerability runtime [`MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_001.md), and application path [`MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_APPLICATION_001`](../contracts/MIP_METHOD_PROMOTION_HANDOFF_ROUTING_ANSWERABILITY_RUNTIME_APPLICATION_001.md) (`mip.contracts.method_promotion_handoff_answerability_application`) — **governance context only**; validate→guard application wrapper; lane paused per [`MIP_ROADMAP_STATE_AUDIT_AFTER_HANDOFF_ANSWERABILITY_APPLICATION_001`](../roadmap/MIP_ROADMAP_STATE_AUDIT_AFTER_HANDOFF_ANSWERABILITY_APPLICATION_001.md); not DecisionSurface, TrustReport bypass, RecommendationContract, planning recommendation, or spend/ROI authorization |
| MMM output → MIP | `DecisionSurface` (full-panel Δμ for production) via `adapters/mmm/` |
| MMM planning answer → LLM explanation | Envelope + renderer + metadata-only LLM response boundary (`mip.contracts.mmm_llm_response_boundary` / `mip.workflows.mmm_llm_response_boundary`); readiness audited in [`MIP_MMM_LLM_RESPONSE_BOUNDARY_APPLICATION_READINESS_AUDIT_001`](../roadmap/MIP_MMM_LLM_RESPONSE_BOUNDARY_APPLICATION_READINESS_AUDIT_001.md); application packaging via [`MIP_MMM_LLM_RESPONSE_BOUNDARY_APPLICATION_001`](../contracts/MIP_MMM_LLM_RESPONSE_BOUNDARY_APPLICATION_001.md) (`mip.llm.mmm_response_boundary_application`) — metadata-only payload packaging, not prompt assembly / user-facing answers / full orchestration; not DecisionSurface/TrustReport/RecommendationContract enablement |
