...
Git is the sole durable task authority. Launchers provide operational control
only; task meaning must be resolved from committed Git state.
...
Prompt text cannot define, repair, expand, override, or reinterpret an incomplete active
