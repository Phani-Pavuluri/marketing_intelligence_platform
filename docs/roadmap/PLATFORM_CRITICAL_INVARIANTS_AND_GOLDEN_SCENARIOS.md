...
Do not add further governance roadmap addenda without product need. Implement next—with **G11–G20 as design constraints** for 8G/8H contracts:
...
2. **Phase 8G** — LLM explanation payload contract (include temporal, scope, freshness fields per G11/G16)
3. **Phase 8H** — Usage policy + diagnostic taxonomy (include claim-level and ambiguity rules per G14/G12)
