...
|---|---|---|---|---|---|---|---|---|---|---|
| DE-0 | Estimand protocol defines the measurable quantities before any criterion is set | P0 + R0 | MIP program owner | Register proposal merged | Estimand-protocol design with named acceptance: `docs/design/MIP_ESTIMAND_PROTOCOL_DESIGN_001.md` at implementation `95aa916a085e6e705674e8652704d884370a55ef` | MIP program/governance owner | — | v1 scope; re-verify on estimand, phase, or gate change | evidence_submitted | none |
