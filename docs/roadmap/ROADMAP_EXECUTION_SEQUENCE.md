...
| MIP GeoX uploaded CSV materialization 001 | ✓ implemented — `mip.contracts.geox_uploaded_csv_materialization`, `mip.workflows.geox_uploaded_csv_materialization` (narrow uploaded CSV materialization; no warehouse/API/artifact-registry ingestion) |
