...
**Immediate next phase:** LLM explanation contract plan (docs); typed explanation contracts + validator after plan merge
...
| LLM explanation contract plan 001 | documented — [LLM_EXPLANATION_CONTRACT_PLAN_001.md](../architecture/LLM_EXPLANATION_CONTRACT_PLAN_001.md) |
...
**LLM explanation contract plan (001):** documented — [LLM_EXPLANATION_CONTRACT_PLAN_001.md](../architecture/LLM_EXPLANATION_CONTRACT_PLAN_001.md). **Blocks LLM runtime** until typed explanation contracts + validator merge.

**Next:** Implement `LLMExplanationRequest` / `LLMExplanationResponse` (report-explanation v1) and `validate_llm_explanation_response`; readiness adapter remains `needs_contract_update`.
